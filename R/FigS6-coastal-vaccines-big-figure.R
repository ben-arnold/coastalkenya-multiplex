...
mtext("Measles MV-N",side=3,line=2,adj=0,cex=1.25,font=2)

# add seroprotection limit (from jeff priest)
segments(x0=min(xtics),x1=max(xtics),y0=log10(178),lty=1,col="gray50")
text(x=mean(xtics),y=log10(125),"Seroprotection limit",col="gray50")
...
mtext("Antibody response (MFI-bg)",side=2,line=3)
mtext("Age-dependent response, by community",side=3,line=0.5,adj=0,cex=1)
mtext("Diphtheria toxoid",side=3,line=2,adj=0,cex=1.25,font=2)

# add seroprotection limit (from jeff priest)
segments(x0=min(xtics),x1=max(xtics),y0=log10(4393),lty=1,col="gray50")
text(x=mean(xtics),y=log10(6000),"Seroprotection limit",col="gray50")
...
mtext("Antibody response (MFI-bg)",side=2,line=3)
mtext("Age-dependent response, by community",side=3,line=0.5,adj=0,cex=1)
mtext("Tetanus toxoid",side=3,line=2,adj=0,cex=1.25,font=2)

# add seroprotection limit (from jeff priest)
segments(x0=min(xtics),x1=max(xtics),y0=log10(118),lty=1,col="gray50")
text(x=mean(xtics),y=log10(80),"Seroprotection limit",col="gray50")
...
mtext(1:10,side=1,line=0,at=1:10,col=cols)
mtext("Mean response, by community",side=3,line=0.5,adj=0)
mtext("Community",side=1,line=2.5)
