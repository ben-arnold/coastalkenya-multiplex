...
mtext(expression(paste(italic("S. stercoralis")," NIE")),side=3,line=0.5,adj=0,cex=1.1,font=1)
...
mtext(expression(paste(italic("Ascaris")," spp. AsHb")),side=3,line=0.5,adj=0,cex=1.1,font=1)
