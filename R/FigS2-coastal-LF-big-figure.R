...
mtext('Lymphatic filariasis Wb123',side=3,line=2,adj=0,cex=1.25,font=2)
...
mtext("Antibody response (MFI-bg)",side=2,line=3)
mtext("Age-dependent mean response, by community",side=3,line=0.5,adj=0,cex=1)
mtext('Lymphatic filariasis Bm14',side=3,line=2,adj=0,cex=1.25,font=2)
...
mtext("Antibody response (MFI-bg)",side=2,line=3)
mtext("Age-dependent mean response, by community",side=3,line=0.5,adj=0,cex=1)
mtext('Lymphatic filariasis Bm33',side=3,line=2,adj=0,cex=1.25,font=2)
